...
seu <- RunUMAP(seu, reduction = "integrated_cca", dims = 1:30, n.neighbors = d.n.neigbors, spread = d.spread, a = 0.8, b = 0.7, reduction.name = "umap") # here we get an error why? 
