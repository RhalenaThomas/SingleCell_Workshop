...
ref <- readRDS("data/Karolinski_DevForebrain_downsample_Level1.RDS")
ref
...
ref2 <- readRDS("data/Nowakowski_dev_cortext.RDS")
ref2
...
Now that we have the an different forms of information to annotate the cells we need to decide on the annotations to add, then add them into the data object.
