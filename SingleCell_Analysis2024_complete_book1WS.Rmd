...
adolescent_data <- Read10X("C:/Users/labuser/Desktop/Data/Adolescent_14_YO_raw_feature_bc_matrix", 
                      strip.suffix = TRUE )
...
adult_data <- Read10X(data.dir = "C:/Users/labuser/Desktop/Data/Adult_41_YO_raw_feature_bc_matrix/", 
                    strip.suffix = TRUE)
...
```{r}
# setwd
setwd("C:/Users/labuser/Downloads/Moein/Educational scRNAseq workshop Jun 2023/DATA")
...
adult_data_seurat <- doubletFinder(adult_data_seurat, PCs = 1:10, pN = 0.25, pK = 0.17, nExp = nExp_poi, reuse.pANN = FALSE, sct = FALSE)
...
VlnPlot(adult_data_seurat, features = c("nCount_RNA", "nFeature_RNA", "percent.MT", "pANN_0.25_0.17_146"), 
